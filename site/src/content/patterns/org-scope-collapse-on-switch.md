...
decision: >-
  ...
  fulfilled payload, keyed on the guard payload and not the org atom (boot,
...
awaits the guard refetches with it. This is the single control point that keeps the
